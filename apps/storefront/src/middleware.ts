...
export const config = {
  matcher: [
    // `kitchen-sink` is a design-token verification surface, not a shop route —
    // it must not be rewritten into a region/locale segment.
    "/((?!api|kitchen-sink|_next/static|_next/image|favicon.ico|images|assets|png|svg|jpg|jpeg|gif|webp).*)",
  ],
}
