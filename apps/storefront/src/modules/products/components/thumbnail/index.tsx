...
const Thumbnail: React.FC<ThumbnailProps> = ({
  ...
  return (
    <Container
      className={clx(
        "relative w-full overflow-hidden p-4 bg-surface shadow-elevation-card-rest  group-hover:shadow-elevation-card-hover transition-shadow ease-in-out duration-150",
        className,
        {
