    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="absolute top-[calc(100%+1px)] right-0 hidden w-[420px] border-x border-b border-gray-200 bg-white text-text small:block"
            ...
            {cartState && cartState.items?.length ? (
                          ...
                          <div className="flex flex-1 flex-col">
                            <div className="flex items-start justify-between">
                              <div className="mr-4 flex w-[180px] flex-col text-ellipsis whitespace-nowrap">
                                <h3 className="overflow-hidden text-small text-ellipsis">
                                  <LocalizedClientLink
                                    href={`/products/${item.product_handle}`}
              ...
              <div>
                <div className="flex flex-col items-center justify-center gap-y-4 py-16">
                  <div className="flex size-6 items-center justify-center bg-gray-900 text-xs text-white">
                    <span>0</span>
                  </div>
